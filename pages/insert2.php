...
<?php
    ...
    $insert = "INSERT INTO Maschine (MOrt, MWI, TypNr) VALUES ('$ort', '$MWI', '$mTyp');";
    ...
    if ($result == FALSE) {
        ...
        echo "<p>WZM-Eintrag Erfolgreich</p>";
        echo "<p>WZM eingetragen unter der WZM-ID: $lastID</p>";
    }
    $lastID = mysqli_insert_id($dblink);
    $date = date("Y-m-d");
    $insert = "INSERT INTO Wartung (MNr, WHinweis, WDatum) VALUES ('$lastID', 'neue WZM', '$date');";
    $result = mysqli_query($dblink, $insert);
    if ($result == FALSE) {
        echo "<p><b>Fehler im SQL-Kommando.</b></p>\n";
        echo "<p>\n";
